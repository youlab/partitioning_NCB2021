...
% =====stochasticity level (% of mean) ===========
sigma_K = 0.5;
% ============================

params_neutral{1}=[0;0];
...
for i = 1:10
    ...
    subplot(1,3,1)
    hold on
%  modify to randomize the local carrying capacity
    yend_house = runSeg_2gamma_Kmod(params_neutral, y0_, nonEmpty, cell_desensity_max, tend,sigma_K);
% =================
    ...
    hold on
%  modify to randomize the local carrying capacity
    yend_house = runSeg_2gamma_Kmod(params_neg, y0_, nonEmpty, cell_desensity_max, tend,sigma_K);
% =================
    ...
    hold on
%  modify to randomize the local carrying capacity
    yend_house = runSeg_2gamma_Kmod(params_pos, y0_, nonEmpty, cell_desensity_max, tend,sigma_K);
% =================
...
%% plot mean and standard deviation on top of the individual simulations
