...
% ==========level of carrying capacity stochasticity========
sigma_K = 0.5; 
% ==========================================================
...
for i = 1:4
    ...
    for j = 1:repeats
        ...
        param_set{4} = 0.8;
        param_set{5} = 3;
        [N_, yend_house, ~, ~] = getOneCurve_Kmod(M,tend,param_set,x0_orig,cellTot,N_res,part_max,1e9,1,sigma_K);
