...
tic
yend_house_s = runSeg_2gamma_stochastic(params, y0_, nonEmpty, cell_desensity_max, tend);
toc

%% plot BI 
[bi,pres, densTot, BIsimpson] = plotBISeg(N_,yend_house_s,cell_desensity_max*vol_tot);
...
subplot(1,2,2)
imagesc(yend_house_s{partLevel})
