function [N_, yend_house,y0_,params]=getOneCurve_LV(M,tend,param_set,x0_orig,cellTot,N_res,part_max,carrying_cap, vol_tot)
...
params = param_generator_lv(M,connectedness,neg_frac,minmax_delta,max_neg,max_pos);
...
tic
yend_house = runSeg_2gamma_LV(params, y0_, nonEmpty, carrying_cap, tend);
toc
