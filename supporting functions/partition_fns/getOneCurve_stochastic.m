function [N_, yend_house,y0_,params]=getOneCurve_stochastic(M,tend,param_set,x0_orig,cellTot,N_res,part_max,carrying_cap, vol_tot)
...
tic
yend_house = runSeg_2gamma_stochastic(params, y0_, nonEmpty, carrying_cap, tend);
toc
